  ...
  <el-tabs v-model="activeTab" :tab-position="tabPosition" class="demo-tabs" @tab-click="handleClick">
    <el-tab-pane name="soCap" label="Phía sơ cấp">
        ...
        >
          ...
          <el-descriptions-item  label="Dòng điện ra I1"> {{ counterStore.handleCalcI1Reverse() }} </el-descriptions-item>
          <el-descriptions-item  label="Số vòng dây N1"> {{ counterStore.handleN1() }}</el-descriptions-item>
          <el-descriptions-item  label="Đường kính dây d1">{{ counterStore.handleD1ReverseType1() }}</el-descriptions-item>
        </el-descriptions>
    </el-tab-pane>
    ...
    <el-tab-pane name="MBA" label="Công suất MBA">
      <el-descriptions
        ...
        >
          ...
          <el-descriptions-item  label="Công suất S2"> {{ counterStore.handleS2Reverse() }} </el-descriptions-item>
      </el-descriptions>
    </el-tab-pane>
  </el-tabs>
